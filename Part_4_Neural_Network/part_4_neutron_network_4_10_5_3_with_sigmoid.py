#Part 4 Neuron Network using Sigmoid/Logistics activation
...
mlp = MLPClassifier(hidden_layer_sizes=(10, 5), activation='logistic', max_iter=1, warm_start=True, random_state=42)
...
cv_scores = cross_val_score(MLPClassifier(hidden_layer_sizes=(10, 5), activation='logistic', 
